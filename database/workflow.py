...
from scheduler.database.models import DBWorkflowModel
...
class DBWorkflow:
    ...
    @classmethod
    def exists(cls, db: DBC, name: str) -> bool:
    ...
    @classmethod
    def insert(cls, db: DBC, name: str, source_node_id: str, destination_node_id: str):
